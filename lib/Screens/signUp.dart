...
import '../Screens/Loggin.dart'
    as supAuth; // Usando el alias 'supAuth' para el AuthProvider
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final authProvider = supAuth
        .AuthProvider(); // Usando la clase AuthProvider del archivo Loggin.dart
        ...
        child: Column(
          children: [
            ...
            TextButton(
              onPressed: () {
                GoRouter.of(context)
                    .go('/login'); // Navegar de regreso al login
              },
